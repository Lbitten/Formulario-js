...
function checkInputs(){
  ...
  if (usernameValue === ""){
    setErrorFor(username, "Nome de usuario obrigatório. ");
  }else{
  ...
  if(passwordConfirmationValue === ""){
    setErrorFor(passwordConfirmation, "Senha é obrigatória. ")
  }else if (passwordConfirmationValue !== passwordValue) {
    setErrorFor(passwordConfirmation, "Senhas não são iguais. ")
  }else{
